            ...
            <table style={{minWidth: '1150px', clear: 'both', marginTop: '30px', marginBottom: '30px' }}>
                <tbody>
                    ...
                    <tr>
                      ...
                      <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 0 ? catagoryData[0].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 0 ? <CheckIcon /> : null} </span></label></td>
                      <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 1 ? catagoryData[1].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 1 ? <CheckIcon /> : null} </span></label></td>
                      <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 2 ? catagoryData[2].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 2 ? <CheckIcon /> : null} </span></label></td>
                      <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 3 ? catagoryData[3].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 3 ? <CheckIcon /> : null} </span></label></td>
                      
                    </tr>
                    <tr>
                    <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 4 ? catagoryData[4].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 4 ? <CheckIcon /> : null} </span></label></td>
                      <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 5 ? catagoryData[5].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 5 ? <CheckIcon /> : null} </span></label></td>
                      <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 6 ? catagoryData[6].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 6 ? <CheckIcon /> : null} </span></label></td>
                      <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 7 ? catagoryData[7].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 7 ? <CheckIcon /> : null} </span></label></td>
                    </tr>
                   
                    <tr>
                      <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 8 ? catagoryData[8].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 8 ? <CheckIcon /> : null} </span></label></td>
                      <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 9 ? catagoryData[9].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 9 ? <CheckIcon /> : null} </span></label></td>
                      <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 10 ? catagoryData[10].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 10 ? <CheckIcon /> : null} </span></label></td>
                      <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {catagoryData.length > 11 ? catagoryData[10].observationTag : null}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{catagoryData.length > 11 ? <CheckIcon /> : null} </span></label></td>
