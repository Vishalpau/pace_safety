            ...
            <tr>
              <td style={{ padding: "15px", backgroundImage: "" }}>
                <span
                  ...
                  class="sec_text_1"
                >
                  <strong>JOB OBSERVATION - CCZJV : </strong>Please write
                  clearly for computer vision read-out
                </span>
                ...
                >
                  <tbody>
                    <tr>
                      ...
                      >
                        OBSERVATION <p>Please write clearly.</p>
                      </td>
                      <td
                        rowspan="4"
                        style={{
                ...
                >
                  <tbody>
                    <tr>
                      ...
                      >
                        ACTION TAKEN <p>Write clearly.</p>
                      </td>
                      <td
                        style={{
                          borderBottom: "1px solid #000",
                      ...
                      >
                        ...
                        {actionTakenData.length > 0
                          ? `${actionTakenData[0].actionNumber} - ${
                              actionTakenData[0].actionTitle
                            }`
                          : "-"}{" "}
                      </td>
                    </tr>
                    <tr>
                      ...
                      >
                        {" "}
                        {actionTakenData.length > 1
                          ? `${actionTakenData[1].actionNumber} - ${
                              actionTakenData[1].actionTitle
                            }`
                          : "-"}{" "}
                      </td>
                    </tr>
                    <tr>
                      ...
                      >
                        {" "}
                        {actionTakenData.length > 2
                          ? `${actionTakenData[2].actionNumber} - ${
                              actionTakenData[2].actionTitle
                            }`
                          : "-"}{" "}
                      </td>
                    </tr>
                            ...
                            <tr>
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    {initialData.observationType === "Risk" ? (
                                      <CheckIcon />
                                    ) : null}{" "}
                                  </span>
                                </label>
                ...
                >
                  <tbody>
                    <tr>
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          <span
                            style={{
                              float: "left",
                              padding: "16px 3px 16px 0px",
                          ...
                          >
                            {projectSturcturedData[0] ? <CheckIcon /> : null}
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {projectSturcturedData[1] ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {projectSturcturedData[2] ? <CheckIcon /> : null}
                          </span>
                        </label>{" "}
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {projectSturcturedData[3]
                              ? projectSturcturedData[3].name
                              : null}
                          </span>{" "}
                          <span
                            style={{
                          ...
                          >
                            {projectSturcturedData[3] ? <CheckIcon /> : null}{" "}
                          </span>{" "}
                        </label>
                      </td>
                    </tr>
                ...
                >
                  <tbody>
                    <tr>
                      ...
                      >
                        CATEGORIES <p>(X) all that apply.</p>
                      </td>
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {catagoryData.length > 0 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {" "}
                            {catagoryData.length > 1
                              ? catagoryData[1].observationTag
                              : null}
                          </span>{" "}
                          <span
                            style={{
                          ...
                          >
                            {catagoryData.length > 1 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {" "}
                            {catagoryData.length > 2
                              ? catagoryData[2].observationTag
                              : null}
                          </span>{" "}
                          <span
                            style={{
                          ...
                          >
                            {catagoryData.length > 2 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {" "}
                            {catagoryData.length > 3
                              ? catagoryData[3].observationTag
                              : null}
                          </span>{" "}
                          <span
                            style={{
                          ...
                          >
                            {catagoryData.length > 3 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                    </tr>
                    <tr>
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {catagoryData.length > 4 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {catagoryData.length > 5 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {" "}
                            {catagoryData.length > 6
                              ? catagoryData[6].observationTag
                              : null}
                          </span>{" "}
                          <span
                            style={{
                          ...
                          >
                            {catagoryData.length > 6 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {" "}
                            {catagoryData.length > 7
                              ? catagoryData[7].observationTag
                              : null}
                          </span>{" "}
                          <span
                            style={{
                          ...
                          >
                            {catagoryData.length > 7 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {" "}
                            {catagoryData.length > 8
                              ? catagoryData[8].observationTag
                              : null}
                          </span>{" "}
                          <span
                            style={{
                          ...
                          >
                            {catagoryData.length > 8 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {" "}
                            {catagoryData.length > 9
                              ? catagoryData[9].observationTag
                              : null}
                          </span>{" "}
                          <span
                            style={{
                          ...
                          >
                            {catagoryData.length > 9 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {" "}
                            {catagoryData.length > 10
                              ? catagoryData[10].observationTag
                              : null}
                          </span>{" "}
                          <span
                            style={{
                          ...
                          >
                            {catagoryData.length > 10 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "right", height: "50px" }}>
                          ...
                          >
                            {catagoryData.length > 11 ? <CheckIcon /> : null}{" "}
                          </span>
                        </label>
                      </td>
                    </tr>
                ...
                >
                  <tbody>
                    <tr>
                      ...
                      >
                        <label style={{ float: "left", height: "50px" }}>
                          <span
                            style={{
                              float: "left",
                              padding: "16px 3px 16px 0px",
                    ...
                    <tr>
                      ...
                      >
                        CONFIRMATION <p>(X) As Applicable.</p>
                      </td>
                      <td
                        style={{
                          border: "1px solid #000",
                      ...
                      >
                        <label style={{ float: "left", height: "50px" }}>
                          ...
                          >
                            {" "}
                            Confirm if you discussed/intervened on the
                            observation:
                          </span>{" "}
                        </label>
                      </td>
                      ...
                      >
                        <label style={{ float: "left", height: "50px" }}>
                          ...
                          >
                            {" "}
                            {initialData.isSituationAddressed === "No" ||
                            initialData.isSituationAddressed === "" ? (
                              <CheckIcon />
                            ) : null}
                          </span>
                        </label>
                    ...
                    <tr>
                      ...
                      >
                        <label style={{ float: "left", height: "50px" }}>
                          ...
                          >
                            {" "}
                            Confirm if you need to escalate the issue
                            (Safety/Management)
                          </span>{" "}
                        </label>
                      </td>
                      ...
                      >
                        <label style={{ float: "left", height: "50px" }}>
                          ...
                          >
                            {initialData.isNotifiedToSupervisor === "Yes" ? (
                              <CheckIcon />
                            ) : null}{" "}
                          </span>
                        </label>
                      ...
                      >
                        <label style={{ float: "left", height: "50px" }}>
                          ...
                          >
                            {initialData.isNotifiedToSupervisor === "No" ||
                    ...
                    <tr>
                      ...
                      >
                        <label style={{ float: "left", height: "50px" }}>
                          ...
                          >
                            {" "}
                            Confirm if you nominate for employee recognition
                          </span>
                        </label>
                      </td>
                      <td
                      ...
                      >
                        <label style={{ float: "left", height: "50px" }}>
                          ...
                          >
                            {initialData.personRecognition === "Yes" ? (
                              <CheckIcon />
                            ) : null}{" "}
                          </span>
                        </label>
                      ...
                      >
                        <label style={{ float: "left", height: "50px" }}>
                          ...
                          >
                            {initialData.personRecognition === "No" ||
