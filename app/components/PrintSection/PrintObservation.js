...
{tagData.slice(8,10).map((value, index) => ( <td  style={{ border: '1px solid #000', padding: '5px 1px 5px 5px', maxWidth: 'calc(100% - 150px)', width: '245px' }}><label style={{ float: 'right', height: '50px'  }}><span style={{ float: 'left', padding: '16px 3px 16px 0px',}}> {tagData[index+8].tagName}</span> <span style={{ padding: '15px', border: '1px solid #000', width: '50px', height: '50px', display: 'inline-block' }}>{tagData[index+8].tagName === catagoryData[index+8].observationTag ?  <CheckIcon /> : null} </span></label></td>
))}
