    ...
    if (companyId) {
      ...
      let data = await api
        ...
        .then(function(res) {
          ...
          let hostings = subscriptionData.filter(
            (item) => item.appCode === "safety"
          )[0].hostings[0].apiDomain;
          let appId = subscriptionData.filter(
            (item) => item.appCode === "safety"
          )[0].appId;
          let subscriptionAction = subscriptionData.filter(
            (item) => item.appCode === "actions"
          );
          let apiUrlDomain = {};
      ...
      <div>
                          ...
                          return (
                            <div>
                              <ListItemLink
                                ...
                                onClick={() =>
                                  handleClick(
                                    subscription.hostings[0].clientId !=
                                      undefined
                                      ? subscription.hostings[0].clientId !=
                                        undefined
                                        ? subscription.hostings.filter(
                                            (hosting) =>
                                              hosting.fkCompanyId ===
                                              JSON.parse(
                                        ...
                                        : ""
                                      : "",
                                    direct_loading.tarProjectStruct,
                                    module.targetPage
                                  )
                                }
                              ...
                              >
                                {Boolean(module.moduleIcon) ? (
                                  <img
                                    className={classnames.appDrawerImage}
        ...
        >
          {isDesktop && companyLogoLink ? (
            ...
            <MenuItem style={{ color: "white" }} color="white">
              {companyName}
            </MenuItem>
          )}
          <Avatar
        ...
        >
          ...
          <MenuItem
            ...
            className="userText"
            onClick={() =>
              (window.location.href = `${SSO_URL}/UserProfile/?companyId=${companyId}&projectId=${projectId}`)
            }
          >
            <svg
              ...
              <g id="Profile-24" transform="translate(-2 -2)">
                ...
                >
                  <path
                    id="Path_2265"
                    data-name="Path 2265"
                    d="M14,2A12,12,0,1,0,26,14,12,12,0,0,0,14,2ZM8.084,21.536C8.6,20.456,11.744,19.4,14,19.4s5.412,1.056,5.916,2.136a9.51,9.51,0,0,1-11.832,0ZM21.632,19.8C19.916,17.708,15.752,17,14,17s-5.916.708-7.632,2.8a9.6,9.6,0,1,1,15.264,0Z"
                    transform="translate(-2 -2)"
                    fill="#06425c"
                  />
                  <path
          ...
          <Divider />
          <MenuItem component={Link} className="userText" disabled={true}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
            ...
            >
              <g id="switch-compnay-24" transform="translate(-96.011 -108.003)">
                <path
                  id="Path_6532"
                  data-name="Path 6532"
                  d="M119.694,519.1a1.088,1.088,0,0,0-.8-.294h-6.416l2.783-2.81h-3.35l-3.945,3.933,3.945,3.933h3.35l-2.783-2.809h5.246v6.181H98.3v-7.351a1.143,1.143,0,1,0-2.286,0v8.391a1.261,1.261,0,0,0,.384.841,1.318,1.318,0,0,0,.866.367h21.634a1.156,1.156,0,0,0,.8-.367,1.193,1.193,0,0,0,.317-.841V519.87a1.027,1.027,0,0,0-.317-.768Z"
                  transform="translate(0 -397.48)"
                  fill="#06425c"
                />
                <path
                  id="Path_6533"
                  data-name="Path 6533"
                  d="M119.719,108.324a1.1,1.1,0,0,0-.794-.321H97.291a1.285,1.285,0,0,0-.87.321,1.162,1.162,0,0,0-.388.8v8.406a1.2,1.2,0,0,0,.388.814,1.3,1.3,0,0,0,.87.339h6.416l-2.783,2.809h3.35l3.945-3.933-3.945-3.933h-3.35l2.783,2.809H98.318v-6.181h19.428v7.26a1.143,1.143,0,1,0,2.286,0v-8.391a1.083,1.083,0,0,0-.313-.8Z"
