...
const ObservationInitialNotification = (props) => {
  ...
  const handelTime = (value) => {
    const noGmt = value.toString().replace('GMT+0530 (India Standard Time)', '');
    const requireTime = moment(noGmt).format().toString();
                ...
                <Grid item md={12} sm={12} xs={12} className="paddTBRemove">
                  <Paper elevation={1} className="paperSection">
                    <Grid container spacing={3}>
                      ...
                      <Grid item md={12} xs={12} className={classes.formBox}>
                        <FormLabel className="checkRadioLabel" component="legend">Do you need to escalate the issue to Individual?</FormLabel>
                        <Autocomplete
                          // multiple
                          className="marginT15"
                          id="combo-box-demo"
