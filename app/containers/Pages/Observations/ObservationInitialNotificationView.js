                ...
                <Grid item md={4} sm={4} xs={12}>
                  ...
                  <Typography className="viewLabelValue">
                    ...
                    {initialData["createdAt"]
                      ? DateFormat(initialData["createdAt"])
                      : "-"}
                  </Typography>
                </Grid>
                <Grid item md={4} sm={4} xs={12}>
            ...
            <Paper elevation={1} className="paperSection">
              <Grid container spacing={3}>
                ...
                {initialData.fkCompanyId === 3 ? (
                  <Grid item md={12} sm={12} xs={12}>
                    <FormLabel component="legend" className="viewLabel">
                      Confirm if the foreman was present at the time of your
                      observation
                    </FormLabel>
                    <Typography className="viewLabelValue">
                      {initialData.isSupervisorPresent
                        ? initialData.isSupervisorPresent
                        : "-"}
                    </Typography>
                  </Grid>
                    ...
                    >
                      {typeof initialData.files === "object" ? (
                        <>
                          ...
                          >
                            {initialData.files.length} Attachment
