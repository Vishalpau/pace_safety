...
import ComplianceBarCharts from './ComplianceBarCharts';
...
class ComplianceFilterTrend extends React.Component {
  state = {
    open: false,
    anchor: 'right',
    button: true
...
ComplianceFilterTrend.propTypes = {
  classes: PropTypes.object.isRequired,
  theme: PropTypes.object.isRequired,
};

export default withStyles(styles, { withTheme: true })(ComplianceFilterTrend);
