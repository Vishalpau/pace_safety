...
class ComplianceFilterKanban extends React.Component {
  state = {
    open: false,
    anchor: 'right',
    button: true
...
ComplianceFilterKanban.propTypes = {
  classes: PropTypes.object.isRequired,
  theme: PropTypes.object.isRequired,
};

export default withStyles(styles, { withTheme: true })(ComplianceFilterKanban);
