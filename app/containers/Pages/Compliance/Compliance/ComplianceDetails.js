  ...
  return (
    <>
        <Grid container spacing={3}>
          ...
          <Grid item md={12} sm={12} xs={12} className="paddTBRemove">
            <Typography variant="h6" className="sectionHeading">
              <svg xmlns="http://www.w3.org/2000/svg" width="33.449" height="39" viewBox="0 0 33.449 39">
                <g id="transfer-inspection" transform="translate(-168.3 -110.5)">
                  <path id="Path_6411" data-name="Path 6411" d="M317.172,305.422a6.983,6.983,0,1,0-3.442,6.013l1.636,1.709a1.216,1.216,0,1,0,1.758-1.68l-1.543-1.612A6.955,6.955,0,0,0,317.172,305.422Zm-6.977,4.538a4.543,4.543,0,1,1,4.543-4.543A4.548,4.548,0,0,1,310.195,309.96Zm2.123-17.742a1.469,1.469,0,0,0-1.422-1.509H293.241a1.512,1.512,0,0,0,0,3.019H310.9A1.482,1.482,0,0,0,312.318,292.217Zm-19.1,4.231a1.512,1.512,0,0,0,0,3.019h6.967a1.512,1.512,0,0,0,0-3.019ZM310.9,284.5H293.241a1.512,1.512,0,0,0,0,3.019H310.9a1.512,1.512,0,0,0,0-3.019Z" transform="translate(-117.487 -165.528)" fill="#06425c"/>
          ...
          <Grid item md={12} sm={12} xs={12} className="paddTBRemove">
            <Typography variant="h6" className="sectionHeading">
              <svg xmlns="http://www.w3.org/2000/svg" width="33.2" height="39" viewBox="0 0 33.2 39">
                <g id="Group_5731" data-name="Group 5731" transform="translate(-1230 -746)">
                  <g id="Group_5727" data-name="Group 5727" transform="translate(117.999)">
                    <path id="personal-information-5" d="M208.566,68.048H177.615a1.124,1.124,0,0,0-1.124,1.124v36.752a1.124,1.124,0,0,0,1.124,1.124h30.951a1.124,1.124,0,0,0,1.124-1.124V69.172A1.124,1.124,0,0,0,208.566,68.048ZM207.442,104.8h-28.7V70.3h28.7Z" transform="translate(935.51 677.952)" fill="#06425c"/>
                  </g>
                  <g id="Group_5728" data-name="Group 5728" transform="translate(118 5)">
                    <path id="personal-information-5-2" data-name="personal-information-5" d="M184.6,97.531h13.977a1.124,1.124,0,0,0,0-2.248H184.6a1.124,1.124,0,0,0,0,2.248Z" transform="translate(935.51 677.952)" fill="#06425c"/>
                  </g>
                  <g id="Group_5730" data-name="Group 5730" transform="translate(117.637 1)">
                    <path id="personal-information-5-3" data-name="personal-information-5" d="M184.6,97.531h6.977a1.124,1.124,0,0,0,0-2.248H184.6a1.124,1.124,0,0,0,0,2.248Z" transform="translate(935.51 677.952)" fill="#06425c"/>
                  </g>
                  <g id="company-7" transform="translate(1233 747.55)">
                    <path id="Path_6422" data-name="Path 6422" d="M16.165,5.481V21.405H5.481V5.481H16.165M16.708,4H4.939A1.036,1.036,0,0,0,4,5.111V21.776a1.036,1.036,0,0,0,.939,1.111H16.708a1.036,1.036,0,0,0,.939-1.111V5.111A1.036,1.036,0,0,0,16.708,4Z" fill="#06425c"/>
                    <path id="Path_6423" data-name="Path 6423" d="M151.666,154.091v3.722h-4.907v-3.722h4.907m1.129-1.481h-7.182c-.311,0-.335.176-.335.393v5.9c0,.217.026.393.335.393H152.8c.311,0,.352-.176.352-.393V153C153.147,152.786,153.106,152.61,152.8,152.61Zm6.962-4.944v10.147h-3.7V147.666h3.7m1.183-1.481H154.86c-.263,0-.283.344-.283.77v11.567c0,.426.02.77.283.77h6.081c.263,0,.3-.344.3-.77V146.955C161.239,146.529,161.2,146.185,160.941,146.185Zm-13.237-1.7h-1.963a.741.741,0,1,1,0-1.481H147.7a.741.741,0,0,1,0,1.481Zm5,0H150.74a.741.741,0,1,1,0-1.481H152.7a.741.741,0,0,1,0,1.481Zm-5,2.907h-1.963a.741.741,0,1,1,0-1.481H147.7a.741.741,0,0,1,0,1.481Zm5,0H150.74a.741.741,0,1,1,0-1.481H152.7a.741.741,0,0,1,0,1.481Zm-5,2.907h-1.963a.741.741,0,1,1,0-1.481H147.7a.741.741,0,0,1,0,1.481Zm5,0H150.74a.741.741,0,1,1,0-1.481H152.7a.741.741,0,0,1,0,1.481Z" transform="translate(-138.389 -136.426)" fill="#06425c"/>
                    <path id="Path_6424" data-name="Path 6424" d="M684.537,478.481H683.8a.741.741,0,1,1,0-1.481h.735a.741.741,0,0,1,0,1.481Zm0,3.314h-.8a.741.741,0,1,1,0-1.481h.8a.741.741,0,0,1,0,1.481Zm0,3.314h-.674a.741.741,0,0,1,0-1.481h.674a.741.741,0,0,1,0,1.481Z" transform="translate(-666.427 -464.242)" fill="#06425c"/>
                  </g>
                </g>
              </svg> Company representative information
            </Typography>
          </Grid>
          <Grid item md={12} sm={12} xs={12} className="paddTBRemove">
            <Paper elevation={1} className="paperSection">
          ...
          <Grid item md={12} sm={12} xs={12} className="paddTBRemove">
            <Typography variant="h6" className="sectionHeading">
              <svg xmlns="http://www.w3.org/2000/svg" width="34.306" height="39" viewBox="0 0 34.306 39">
                <g id="Group_5720" data-name="Group 5720" transform="translate(-764 -746)">
                  <g id="transfer-inspection" transform="translate(595.7 635.5)">
                    <path id="Path_6411" data-name="Path 6411" d="M312.318,292.217a1.469,1.469,0,0,0-1.422-1.509H293.241a1.512,1.512,0,0,0,0,3.019H310.9A1.482,1.482,0,0,0,312.318,292.217Zm-19.1,4.231a1.512,1.512,0,0,0,0,3.019h6.967a1.512,1.512,0,0,0,0-3.019ZM310.9,284.5H293.241a1.512,1.512,0,0,0,0,3.019H310.9a1.512,1.512,0,0,0,0-3.019Z" transform="translate(-117.487 -165.528)" fill="#06425c"/>
                    <path id="Path_6412" data-name="Path 6412" d="M185.487,146.579H171.226s0,0,0,0V113.426s0,0,0,0h27.6s0,0,0,0v17.358a1.461,1.461,0,1,0,2.921,0V113.421a2.924,2.924,0,0,0-2.921-2.921H171.221a2.924,2.924,0,0,0-2.921,2.921v33.157a2.924,2.924,0,0,0,2.921,2.921h14.266a1.461,1.461,0,1,0,0-2.921Z" fill="#06425c"/>
                  </g>
                  <g id="Group_5719" data-name="Group 5719">
                    <g id="groups-svgrepo-com" transform="translate(763.725 744.337)">
                      <g id="Group_5616" data-name="Group 5616" transform="translate(16 25)">
                        <path id="Path_6342" data-name="Path 6342" d="M21.657,32.487a4.79,4.79,0,0,1-.738-2.569,4.661,4.661,0,0,1,1.776-3.8A2.268,2.268,0,0,0,20.646,25a2.487,2.487,0,0,0-2.459,2.733,2.573,2.573,0,0,0,.792,1.94,1.45,1.45,0,0,1,.547,1.011c0,.383-.137.71-1.038,1.093-1.284.574-2.459,1.312-2.487,2.514a1.266,1.266,0,0,0,1.257,1.366h1.175a.529.529,0,0,0,.465-.273,5.583,5.583,0,0,1,2.541-2.131A.509.509,0,0,0,21.657,32.487Z" transform="translate(-16 -25)" fill="#06425c"/>
                      </g>
                      <g id="Group_5617" data-name="Group 5617" transform="translate(27.887 25)">
                        <path id="Path_6343" data-name="Path 6343" d="M63.708,31.777c-.9-.383-1.038-.738-1.038-1.093a1.45,1.45,0,0,1,.547-1.011,2.573,2.573,0,0,0,.792-1.94A2.487,2.487,0,0,0,61.549,25,2.268,2.268,0,0,0,59.5,26.12a4.623,4.623,0,0,1,1.776,3.8,4.564,4.564,0,0,1-.738,2.569.542.542,0,0,0,.219.792A5.583,5.583,0,0,1,63.3,35.411a.529.529,0,0,0,.465.273h1.175a1.266,1.266,0,0,0,1.257-1.366C66.168,33.116,64.993,32.351,63.708,31.777Z" transform="translate(-59.5 -25)" fill="#06425c"/>
                      </g>
                      <g id="Group_5618" data-name="Group 5618" transform="translate(20.099 26.913)">
                        <path id="Path_6344" data-name="Path 6344" d="M38.569,39.487c-.984-.41-1.12-.792-1.12-1.2a1.644,1.644,0,0,1,.6-1.12,2.86,2.86,0,0,0,.9-2.159,2.745,2.745,0,1,0-5.465,0,2.9,2.9,0,0,0,.9,2.159,1.644,1.644,0,0,1,.6,1.12c0,.41-.164.792-1.12,1.2-1.476.6-2.842,1.312-2.869,2.623a1.559,1.559,0,0,0,1.448,1.64h7.487a1.559,1.559,0,0,0,1.448-1.64C41.357,40.8,39.99,40.089,38.569,39.487Z" transform="translate(-31 -32)" fill="#06425c"/>
                      </g>
                    </g>
                  </g>
                </g>
    ...
    {/* <Grid container spacing={3} className={classes.observationNewSection}>
        <Grid
          ...
          >
            <Typography variant="label" className={classes.mainLabelName}>Project Information</Typography>
        </Grid>
        ...
        >
          ...
          >
            ...
            <FormControl component="fieldset">
              <FormLabel component="legend" className={classes.labelName}>Select the type of compliance check *</FormLabel>
              <RadioGroup aria-label="select-typeof-compliance" name="select-typeof-compliance">
                <FormControlLabel value="contractor-compliance" className={classes.labelValue} control={<Radio />} label="Contractor compliance check" />
                <FormControlLabel value="workarea-compliance" className={classes.labelValue} control={<Radio />} label="Work area compliance check" />
                <FormControlLabel value="general-compliance" className={classes.labelValue} control={<Radio />} label="General compliance / spot check" />
              </RadioGroup>
            </FormControl>
          </Grid>
          <Grid
              ...
              >
                ...
                <MuiPickersUtilsProvider utils={DateFnsUtils}>
                  <KeyboardDatePicker
                    ...
                    fullWidth
                    label="Date of compliance check*"
                    value={selectedDate}
                    onChange={handleDateChange}
                    inputVariant="outlined"
                    disableFuture="true"
          ...
          style={{marginTop: '12px'}}
          >
            <Typography variant="label" className={classes.mainLabelName}>Company representative information</Typography>
          </Grid>
          <Grid
            item
            md={6}
          ...
          style={{marginTop: '12px'}}
          >
            <Typography variant="label" className={classes.mainLabelName}>Contractor information</Typography>
          </Grid>
          <Grid
            item
            md={6}
          ...
          >
            <Typography variant="label" gutterBottom className={classes.mainLabelName}>Inspection team</Typography>
          </Grid>
          <Grid
          item
          md={6}
