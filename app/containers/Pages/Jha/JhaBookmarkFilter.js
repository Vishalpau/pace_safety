...
import JhaBookmarkPackage from './JhaBookmarkPackage';
...
class JhaBookmarkFilter extends React.Component {
  state = {
    open: false,
    anchor: 'right',
    button: true
...
JhaBookmarkFilter.propTypes = {
  classes: PropTypes.object.isRequired,
  theme: PropTypes.object.isRequired,
};

export default withStyles(styles, { withTheme: true })(JhaBookmarkFilter);