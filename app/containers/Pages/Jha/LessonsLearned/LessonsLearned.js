...
const LessonsLearned = () => {
  ...
  const handelSubmit = async () => {
    if (form.anyLessonsLearnt == "Yes" || form.anyLessonsLearnt == "No") {
      ...
      history.push(
        `${SUMMARY_FORM.Summary}/${localStorage.getItem("fkJHAId")}`
      );
    } else {
  ...
  return (
    <>
      <CustomPapperBlock
        title="Assessment - Lessons learned"
                    ...
                    <Grid item md={8} xs={12}>
                      <Grid container spacing={3}>
                        <Grid item md={12} xs={12} className={classes.formBox}>
                          <FormControl
                            component="fieldset"
                            error={error && error["LessonDecide"]}
                          >
                            <FormLabel
                              component="legend"
                              ...
                              {radioDecide.map((value) => (
                                <FormControlLabel
                                  ...
                                  onChange={(e) =>
                                    setForm({
                                      ...form,
                                      anyLessonsLearnt: e.target.value,
                                    })
                                  }
                                />
                              ))}
                            ...
                            >
                              <TextField
                                ...
                                onChange={(e) =>
                                  setForm({
                                    ...form,
                                    lessonLearntDetails: e.target.value,
                                  })
                                }
                              />
                            </Grid>
