                                  ...
                                  <Grid item xs={12} md={12} >
                                    <FormLabel className="viewLabel" component="legend">Job hazard</FormLabel>
                                    {
                                      hazard !== undefined && hazard.length > 0 ? hazard.map((value, index) => (
                                        ...
                                        <Typography className="viewLabelValue">
                                          {value.hazard == 'N/A' ? null : checkValue(value.hazard)}
                                        </Typography>
                                      )) : "-"
                                    }
                                  </Grid>
                                    ...
                                    <Typography className="viewLabelValue">
                                      {
                                        hazard !== undefined && hazard.length > 0 ? hazard.map((value, index) => (
                                          ...
                                          <Typography className="viewLabelValue">
                                            {value.safetyChecks == 'NA' ? null : checkValue(value.safetyChecks)}
                                          </Typography>
                                        )) : "-"
                                      }
                                    </Typography>
                              ...
                              <Paper elevation={1} className="paperSection">
                                <Grid container spacing={3}>
                                  <Grid
                                    ...
                                    xs={12}
                                  >
                                    {hazard !== undefined && hazard.map((value, index) => value.hazard == 'N/A' ? null :
