...
import {
  handelActionData,
  handelActionDataAssessment,
  handelActionWithEntity,
...
function JhaSummary(props) {
  ...
  const assessmentDataValues = async () => {
    ...
    const apiDataPerformance =
      specificPerformance.data.data.results.length > 0
        ? specificPerformance.data.data.results[0].checklistGroups
        : [];

    const documentCondition = await api.get(
      `${baseUrl}/api/v1/core/checklists/jha-document-conditions/${projectId}/`
    );
    const apiCondition =
      documentCondition.data.data.results.length > 0
        ? documentCondition.data.data.results[0].checklistValues
        : [];
  ...
  const handelWorkArea = async (assessment) => {
    ...
    for (let key in projectStructId) {
      ...
      const workArea = await api_work_area.get(
        `/api/v1/companies/${assessment.fkCompanyId}/projects/${
          assessment.fkProjectId
  ...
  const handelApprovalTabStatus = () => {
    ...
    assessment["sapApprovalDateTime"] !== null
      ? (approvalStatusDecide = true)
      : (approvalStatusDecide = false);
  ...
  const handelLessionLearnedChanges = (side) => {
    if (
      formStatus.assessmentStatus === true &&
      formStatus.approvalStatus === true
    ) {
      setAssessmentsView(false);
      setApprovalsView(false);
      setCloseOutView(false);
      ...
      formStatus.assessmentStatus === false &&
      formStatus.approvalStatus === false
    ) {
      setMessageSnackbar(
        `${errorMessage} ${errorAssessment} and ${errorApproval} `
      );
      handleClickSnackBar();
    } else if (
      formStatus.assessmentStatus === true &&
  ...
  return (
    <CustomPapperBlock
      title={`Assessment Number: ${
        assessment.jhaNumber !== undefined ? assessment.jhaNumber : ""
      }`}
      icon="customDropdownPageIcon jsaPageIcon"
      whiteBg
    >
      {loader == false ? (
                              ...
                              >
                                ...
                                >
                                  <g
                                    ...
                                    transform="translate(-1177 -226)"
                                  >
                                    <g
                                      id="Group_5477"
                                      data-name="Group 5477"
                                      transform="translate(626 89)"
                                    >
                                      <g
                                        id="outline-assignment-24px"
                                        transform="translate(551 137)"
                                      >
                                        <g id="Bounding_Boxes">
                                          <path
                                            id="Path_2274"
                                        ...
                                        <path
                                          ...
                                          d="M13.971,2.694,18.572,7h-4.6V2.694Zm-9.105,13.6a.5.5,0,0,0-.47.519.488.488,0,0,0,.47.519h5.773V16.294Zm0,3.718a.5.5,0,0,0-.47.519.488.488,0,0,0,.47.519h5.773V20.012Zm0-11.155a.5.5,0,0,0-.47.519.491.491,0,0,0,.47.519H10.2a.52.52,0,0,0,0-1.038Zm0-3.718a.5.5,0,0,0-.47.519.488.488,0,0,0,.47.519H7.8a.5.5,0,0,0,.47-.519.491.491,0,0,0-.47-.519Zm0,7.438a.52.52,0,0,0,0,1.038h9.028a.5.5,0,0,0,.47-.519.491.491,0,0,0-.47-.519Zm16.27-4.955a.766.766,0,0,0-.557-.737L13.8.282A.754.754,0,0,0,13.206,0H1.379A1.376,1.376,0,0,0,0,1.376V24.953a1.372,1.372,0,0,0,.4.975,1.388,1.388,0,0,0,.975.4H10.66V24.791H1.538V1.541H12.433V7.769a.773.773,0,0,0,.773.773h6.388v5.038h1.543Z"
                                          transform="translate(2.325 1.144)"
                                          fill="#06425c"
                                        />
                                      </g>
                                      <path
                                        ...
                                        d="M22.832,27.629c-.136-.211-.388-.5-.388-.756a.4.4,0,0,1,.272-.359c0-.211-.021-.43-.021-.643v-.38a1.294,1.294,0,0,1,.042-.235,1.348,1.348,0,0,1,.606-.77,1.839,1.839,0,0,1,.329-.157c.209-.075.106-.425.333-.43a2.987,2.987,0,0,1,1.75.843,1.36,1.36,0,0,1,.348.876l-.021.939a.3.3,0,0,1,.235.19c.073.3-.235.66-.373.895s-.632.916-.632.921a.186.186,0,0,0,.045.108c.777,1.069,3.053.395,3.053,2.518H20.343c0-2.114,2.283-1.449,3.053-2.518.038-.056.056-.087.054-.11s-.575-.829-.625-.909h0Z"
                                        transform="translate(548.748 132.768)"
                                        fill="#fff"
                                      />
                                    </g>
                                    <g
                                      id="construction-engineer"
                                      transform="translate(1191 241.5)"
                                    >
                                      <path
                                        id="Path_5202"
                                        data-name="Path 5202"
                              ...
                              <Paper elevation={1} className="paperSection">
                                <Grid container spacing={3}>
                                  ...
                                  <Grid item xs={12} md={12}>
                                    ...
                                    {hazard !== undefined && hazard.length > 0
                              ...
                              <Paper elevation={1} className="paperSection">
                                <Grid container spacing={3}>
                                  ...
                                  <Grid item xs={12} md={6}>
                                    ...
                                    <Typography className="viewLabelValue">
                                      {checkValue(
                                        assessment.evacuationAssemblyPoint
                                      )}
                                    </Typography>
                                  </Grid>
                            ...
                            >
                              <Paper elevation={1} className="paperSection">
                                <Grid container spacing={3}>
                                  ...
                                  assessment.workStopCondition.split(",")
                                    .length > 0 ? (
                                    <Grid item xs={12} md={12}>
                                      <Typography
                                        variant="h6"
                                      ...
                                      {checkValue(assessment.workStopCondition)
                                        .split(",")
                                        .map((value) => (
                                          <p>{checkListAssessment[value]}</p>
                                        ))}
                                    </Grid>
                                  ) : null}
                                  ...
                                  assessment.humanPerformanceAspects !== "" &&
                                  assessment.humanPerformanceAspects.split(",")
                                    .length > 0 ? (
                                    <Grid item xs={12} md={12}>
                                      <Typography
                                        variant="h6"
                                        ...
                                        className={Fonts.labelName}
                                      >
                                        Specific human performance aspects that
                                        have been discussed before commencing
                                        the work
                                      </Typography>
                                      <Typography
                                        variant="body"
                                ...
                                <Grid container spacing={3}>
                                  <Grid item md={12} sm={12} xs={12}>
                                    ...
                                    <Typography className="labelValue">
                                      {Object.entries(projectStructName).map(
                                        ([key, value], index) => (
                                          <>
                                            {Object.keys(projectStructName)[
                                              index + 1
                                            ] !== undefined
                                              ? `${value} : `
                                              : `${value}`}
                            ...
                            >
                              ...
                              >
                                <svg
                                  ...
                                  width="25.698"
                                  height="27.581"
                                  viewBox="0 0 25.698 27.581"
                                >
                                  <g
                                    id="Group_5491"
                                    data-name="Group 5491"
                                    transform="translate(-1474 -226)"
                                  >
                                    <g
                                ...
                                <Grid container spacing={3}>
                                  ...
                                  {assessment.anyLessonsLearnt === "Yes" ? (
                                    <Grid item xs={12} md={6}>
                                      ...
                                      <Typography className="viewLabelValue">
                                        {assessment.lessonLearntDetails
                                          ? assessment.lessonLearntDetails
                                          : "-"}
                                      </Typography>
                                    </Grid>
                          ...
                          <Grid item xs={12}>
                            <Grid container spacing={3}>
                              ...
                              <Grid item xs={12} md={6}>
                                ...
                                >
                                  {moment(
                                    checkValue(assessment.closedDate)
                                  ).format("Do MMM YYYY")}
                                </Typography>
                              </Grid>
                            </Grid>
          ...
          <Grid item xs={12} md={3}>
            <div className="quickActionSection">
              ...
              <List component="nav" aria-label="main mailbox folders">
                <ListItem button disabled={formStatus.closeOutStatus}>
                  <ListItemIcon>
                    {formStatus.assessmentStatus ? <Edit /> : <Add />}
                  </ListItemIcon>
                  <Link variant="subtitle" onClick={(e) => handleNewJhaPush(e)}>
                    <ListItemText
                      primary={
                        formStatus.assessmentStatus
                          ? "Modify assessment"
