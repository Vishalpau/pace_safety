...
class JhaFilterTrend extends React.Component {
  state = {
    open: false,
    anchor: 'right',
    button: true
...
JhaFilterTrend.propTypes = {
  classes: PropTypes.object.isRequired,
  theme: PropTypes.object.isRequired,
};

export default withStyles(styles, { withTheme: true })(JhaFilterTrend);