...
import { HEADER_AUTH, SSO_URL, userId } from "../../../utils/constants";
...
const FlhaDetails = (props) => {
  ...
  const createFlha = async () => {
    ...
    if (
      jobForm.files !== null &&
      jobForm.files !== undefined &&
      typeof jobForm.files !== "string"
    ) {
  ...
  const createCriticalTask = async (flha) => {
    ...
    const res = await api.post(`/api/v1/flhas/${flha}/criticaltasks/`, data);
  ...
  const handleRiskChange = (e, key, taskIndex, fieldname) => {
    ...
    const riskSeverity =
      temp[taskIndex].hazards[key].riskSeverityValue == undefined ||
      temp[taskIndex].hazards[key].riskSeverityValue == "" ||
      isNaN(temp[taskIndex].hazards[key].riskSeverityValue)
        ? 1
        : temp[taskIndex].hazards[key].riskSeverityValue;
    const riskProbability =
      temp[taskIndex].hazards[key].riskProbabilityValue == undefined ||
      temp[taskIndex].hazards[key].riskProbabilityValue == "" ||
      isNaN(temp[taskIndex].hazards[key].riskProbabilityValue)
        ? 1
        : temp[taskIndex].hazards[key].riskProbabilityValue;
    ...
    if (riskRating >= 1 && riskRating <= 4) {
      ...
      temp[taskIndex].hazards[
        key
      ].riskRatingLevel = `${riskRating} Substantial`;
      temp[taskIndex].hazards[key].riskRatingColour = "#990000";
    } else {
      temp[taskIndex].hazards[
        key
      ].riskRatingLevel = `${riskRating} Intolerable`;
  ...
  const handelNotifyTo = async (e, value) => {
    const temp = { ...jobForm };
    !Array.isArray(temp.notifyTo)
      ? (temp.notifyTo = [])
      : (temp.notifyTo = temp.notifyTo);
                ...
                <Paper elevation={1} className="paperSection">
                  <Grid container spacing={3}>
                    <Grid item xs={9}>
                      ...
                      />
                      <div style={{ color: "red" }}>
                        {jobForm.jobTitle ? "" : error.jobTitle}
                      </div>
                    </Grid>
                          ...
                          <Grid container spacing={3}>
                            <Grid item md={6} sm={6} xs={12}>
                              <Autocomplete
                                ...
                                onChange={(e, value) => {
                                  handleDepartmentSelection(e, value);
                              ...
                              {jobTitles.length > 0
                                ? jobTitles.map((jobTitle) => (
                                    <Grid
                                      ...
                                      xs={3}
                                      onClick={() =>
                                        handleJobSelection(jobTitle.id)
                                      }
                                    >
                                      <Tooltip
                    ...
                    <Grid item xs={12}>
                      <TextField
                        ...
                        value={
                          departmentList != null &&
                          departmentList.departmentName != undefined
              ...
              <Grid item xs={12}>
                <Box padding={0}>
                  ...
                  <Grid
                    ...
                    sm={12}
                    xs={12}
                    className={classes.criticalHazardSection}
                  >
                    <div>
                      {taskForm.map((taskValue, taskIndex) => (
                        <Accordion
                          expanded={expanded === "panel"}
                          onChange={handleTwoChange("panel")}
                          defaultExpanded
                            ...
                            <Grid container justify="flex-end">
                              <Button>
                                <DeleteForeverOutlinedIcon
                                  onClick={(e) => handelTaskRemove(taskIndex)}
                                />
                              </Button>
                            </Grid>
                          </AccordionSummary>
                                ...
                                >
                                  ...
                                  >
                                    <Typography className={classes.heading}>
                                      ...
                                      {indexHazard + 1} -{" "}
                                      {
                                        taskForm[taskIndex].hazards[indexHazard]
                                          .hazard
                                      }
                                    </Typography>
                                    <Typography
                                  ...
                                  <AccordionDetails>
                                    <Grid container spacing={2}>
                                      ...
                                      <Grid item md={8} sm={8} xs={8}>
                                        {item.hazardImage ? (
                                          <img
                                            src={item.hazardImage}
                                            alt="decoration"
                                            className={classes.mttopEight}
                                            height={56}
                                          />
                                        ) : (
                                          ""
                                        ...
                                        >
                                          <FormControl component="fieldset">
                                            ...
                                            <RadioGroup
                                              ...
                                              aria-label="hazardStatus"
                                              name="hazardStatus"
                                              value={item.hazardStatus}
                                              onChange={(e) =>
                                                handleHazardForm(
                                                  e,
                                                  indexHazard,
                                      ...
                                      {/* <Grid container spacing={3}> */}
                                      {item.hazardStatus === "Yes" ||
                                      item.hazardStatus === "" ||
                                      item.hazardStatus === undefined ? (
                                        <>
                                          <Grid item sm={12} xs={12}>
                                            <TextField
                                              multiline
                                          ...
                                          <Grid item sm={12} xs={12}>
                                            <FormControl component="fieldset">
                                              <FormLabel
                                                ...
                                                className="checkRadioLabel"
                                              >
                                                Has this control been put in
                                                place?
                                              </FormLabel>
                                              <RadioGroup
                                                className={classes.radioInline}
                                                aria-label="controlStatus"
                                                name="controlStatus"
                                                value={item.controlStatus}
                                                onChange={(e) =>
                                                  handleHazardForm(
                                                    e,
                                                    indexHazard,
                                            ...
                                            >
                                              {item.riskRatingLevel || (
                                                <span style={{ color: "grey" }}>
                                                  Please select Risk severity or
                                                  Risk probability
                                                </span>
                                              )}
                                            </div>
                  ...
                  <Grid container spacing={3}>
                            ...
                            <TableRow className={classes.cellHeight}>
                                ...
                                <div className={classes.spacer}>
                                  <FormControl component="fieldset">
                                    <RadioGroup
                                      row
                                      aria-label="status"
                                      name="visualConfirmationStatus"
                                      value={
                                        jobConfirmation[0]
                                          .visualConfirmationStatus
                                      }
                                      onChange={(e) =>
                                        handleJobConfirmationFormChange(
                                          e,
                                          "visualConfirmationStatus",
                                          0
                                        )
                              ...
                              <TableCell align="left">
                                <input
                                  ...
                                  disabled={
                                    !!(
                                      jobConfirmation[0]
                                        .visualConfirmationStatus === "" ||
                                      jobConfirmation[0]
                                        .visualConfirmationStatus === "No" ||
                                      jobConfirmation[0]
                                        .visualConfirmationStatus === "N/A"
                                    )
                                  }
                                  value={
                                    jobConfirmation.visualConfirmationAttachment
                                  }
                                  onChange={(e) =>
                                    handleJobConfirmationFormChange(
                                      e,
                                  ...
                                  onChangeclassName="tableFileAttach"
                                  id="icon-button-file"
                                  name="visualConfirmationAttachment"
                                  type="file"
                                />
                              </TableCell>
                            </TableRow>
                    ...
                    <Grid item md={4} xs={12}>
                      <FormControl component="fieldset">
                        ...
                        <RadioGroup
                          row
                          aria-label="permitToWork"
                          name="permitToWork"
                          value={jobForm.permitToWork}
                          onChange={(e) => {
                            setJobForm({
                              ...jobForm,
                        ...
                        <div style={{ color: "red" }}>
                          {jobForm.permitToWork ? "" : error.permitToWork}
                        </div>
                      </FormControl>
                    </Grid>
                    {jobForm.permitToWork === "yes" ||
                    jobForm.permitToWork === "" ||
                    jobForm.permitToWork === undefined ? (
                      <>
                        <Grid item md={12} sm={12} xs={12}>
                          <Grid container spacing={3}>
                            <Grid
                  ...
                  <Grid container spacing={3}>
                    <Grid item md={5} xs={12}>
                      <FormControl component="fieldset">
                        ...
                        <div style={{ color: "red" }}>
                          {jobForm.firstAid ? "" : error.firstAid}
                        </div>
                      </FormControl>
                    </Grid>
                    <Grid item md={4} xs={12}>
                  ...
                  <Grid container spacing={3}>
                    <Grid item md={5} xs={12}>
                      <FormControl component="fieldset">
                        ...
                        <RadioGroup
                          row
                          aria-label="jhaReviewed"
                          name="jhaReviewed"
                          value={jobForm.jhaReviewed}
                          onChange={(e) => {
                            setJobForm({
                              ...jobForm,
                        ...
                        <div style={{ color: "red" }}>
                          {jobForm.jhaReviewed ? "" : error.jhaReviewed}
                        </div>
                      </FormControl>
                    </Grid>
                    <Grid item md={4} xs={12}>
                  ...
                  <Grid container spacing={3}>
                    <Grid item md={5} xs={12}>
                      <FormControl component="fieldset">
                        ...
                        <RadioGroup
                          row
                          aria-label="accessToJobProcedure"
                          name="accessToJobProcedure"
                          value={jobForm.accessToJobProcedure}
                          onChange={(e) => {
                            setJobForm({
                              ...jobForm,
                        ...
                        <div style={{ color: "red" }}>
                          {jobForm.accessToJobProcedure
                            ? ""
                            : error.accessToJobProcedure}
                        </div>
                      </FormControl>
                    </Grid>
                    <Grid item md={4} xs={12}>
