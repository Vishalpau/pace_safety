...
const FlhaDetails = (props) => {
  ...
  const createFlha = async () => {
    ...
    const fkProjectStructureId = uniqueProjectStructure.map(depth => depth).join(':');
                          ...
                          >
                            <Grid container spacing={3}>
                              {(jobTitles.length > 0) ? jobTitles.map((jobTitle) => (
                                <Grid item xs={3} onClick={() => handleJobSelection(jobTitle.id)}>
                                  <Tooltip title={jobTitle.jobTitle} placement="bottom"><img src={jobTitle.jobTitleImage} alt="decoration" /></Tooltip>
                                  {jobTitle.jobTitle}
                                </Grid>
                              )) : ''}
                              {departmentList
...
-
                            ...
                            <Grid container justify="flex-end">
                              <Button>
                                <DeleteForeverOutlinedIcon onClick={(e) => handelTaskRemove(taskIndex)} />
                              </Button>
                            </Grid>
                          </AccordionSummary>
                          <AccordionDetails>
...
-
                                  ...
                                  <Grid container justify="flex-end">
                                    <Button>
                                      <DeleteForeverOutlinedIcon onClick={(e) => handelRemoveHazards(taskIndex, indexHazard)} />
                                    </Button>
                                  </Grid>
                                </AccordionSummary>
                                <AccordionDetails>
                        ...
                        <Table className={classes.table} aria-label="simple table">
                          ...
                          <TableBody>
                            <TableRow className={classes.cellHeight}>
                              ...
                              <TableCell align="left">
                                <input accept="image/*" disabled={!!(jobConfirmation[0].visualConfirmationStatus === '' || jobConfirmation[0].visualConfirmationStatus === 'No' || jobConfirmation[0].visualConfirmationStatus === 'N/A')} value={jobConfirmation.visualConfirmationAttachment} onChange={(e) => handleJobConfirmationFormChange(e, 'visualConfirmationAttachment', 0)} onChangeclassName="tableFileAttach" id="icon-button-file" name="visualConfirmationAttachment" type="file" />
                              </TableCell>
                            </TableRow>
                            <TableRow className={classes.cellHeight}>
                            ...
                            <TableRow className={classes.cellHeight}>
                              ...
                              <TableCell align="left">
                                <input accept="image/*" disabled={!!(jobConfirmation[2].visualConfirmationStatus === '' || jobConfirmation[2].visualConfirmationStatus === 'No' || jobConfirmation[2].visualConfirmationStatus === 'N/A')} type="file" value={jobConfirmation.visualConfirmationAttachment} onChange={(e) => handleJobConfirmationFormChange(e, 'visualConfirmationAttachment', 2)} onChangeclassName="tableFileAttach" id="icon-button-file" />
                              </TableCell>
                            </TableRow>
                          </TableBody>
                        </Table>
