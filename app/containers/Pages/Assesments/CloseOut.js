              ...
              {jobForm.workerWorking === "Yes" || jobForm.workerWorking == null ?
                ...
                null
                  ...
                  <Grid item md={6} sm={6} xs={12}>
                    <FormControl component="fieldset">
                      ...
                      <RadioGroup
                        className={classes.radioInline}
                        aria-label="permitClosedOut"
                        name="permitClosedOut"
                        value={jobForm.permitClosedOut}
                        onChange={(e) =>
                          handleJobFormChange(e, "permitClosedOut")
                        }
                      >
                        <FormControlLabel
                          value="Yes"
                  ...
                  <Grid item md={6} sm={6} xs={12}>
                    <FormControl component="fieldset">
                      <FormLabel component="legend" className="checkRadioLabel">
                        Are there Hazards remaining?*
                      </FormLabel>
                      <RadioGroup
                        className={classes.radioInline}
                        aria-label="hazardsRemaining"
                        name="hazardsRemaining"
                        value={jobForm.hazardsRemaining}
                        onChange={(e) =>
                          handleJobFormChange(e, "hazardsRemaining")
                        }
                      >
                        <FormControlLabel
                          value="Yes"
                  ...
                  <Grid item md={6} sm={6} xs={12}>
                    <FormControl component="fieldset">
                      ...
                      <RadioGroup
                        ...
                        aria-label="endOfJob"
                        name="endOfJob"
                        value={jobForm.endOfJob}
                        onChange={(e) => handleJobFormChange(e, "endOfJob")}
                      >
                        <FormControlLabel
                          value="Yes"
                          control={<Radio />}
                  ...
                  <Grid item md={6} sm={6} xs={12}>
                    <FormControl component="fieldset">
                      ...
                      <RadioGroup
                        className={classes.radioInline}
                        aria-label="anyIncidents"
                        name="anyIncidents"
                        value={jobForm.anyIncidents}
                        onChange={(e) => handleJobFormChange(e, "anyIncidents")}
                      >
                        <FormControlLabel
                          value="Yes"
                          control={<Radio />}
                  ...
                  jobForm.anyIncidents == null ? (
                    <Grid item md={12} xs={12}>
                      ...
                      <TextField
                        ...
                        onChange={(e) =>
                          handleJobFormChange(e, "jobCompletionRemarks")
                        }
                        className={classes.fullWidth}
                        disabled={disableForm}
                      />
                  ...
                  <Grid item md={6} sm={6} xs={12}>
                    <FormControl component="fieldset">
                      <FormLabel component="legend" className="checkRadioLabel">
                        Do you want to continue to creating an Incident?*
                      </FormLabel>
                      <RadioGroup
                        className={classes.radioInline}
                        aria-label="creatingIncident"
                        name="creatingIncident"
                        value={jobForm.creatingIncident}
                        onChange={(e) =>
                          handleJobFormChange(e, "creatingIncident")
                        }
                      >
                        <FormControlLabel
                          value="Yes"
                  ...
                  {false && (
                    <Grid
                      ...
                      sm={12}
                      xs={12}
                      className="paddTRemove formFieldBTNSection"
                    >
                      <Button className="marginT0" variant="outlined">
                        Acknowledge{" "}
                      </Button>
                    </Grid>
                  )}
                ...
                {false && (
                  <Grid
                    ...
                    md={12}
                    xs={12}
                    className="buttonActionArea marginT10"
                  >
                    <Button
                      size="medium"
                      variant="contained"
                ...
                <Grid item md={12} sm={12} xs={12} className="buttonActionArea">
                  <div className={classes.loadingWrapper}>
                    <Button
                      ...
                      disabled={
                        loading || disableForm || jobForm.flhaStage === "Close"
                      }
                    >
                      Closeout
                    </Button>
