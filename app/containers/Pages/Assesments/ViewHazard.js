...
const FlhaDetails = (props) => {
  ...
  const handleRiskChange = (rating) => {
    ...
    if (
      ...
      rating === "17 Substantial" ||
      rating === "18 Substantial" ||
      rating === "19 Substantial" ||
      rating === "20 Substantial" ||
      rating === "21 Substantial" ||
      rating === "22 Substantial" ||
      rating === "23 Substantial" ||
      rating === "24 Substantial"
    ) {
      colorRating = "#990000";
    } else {
      colorRating = "#FFBF00";
  ...
  useEffect(() => {
    ...
    props.criticalTasks,
    props.visualConfirmations,
    props.flha,
    props.notifyToValues,
  ]);
                          ...
                          >
                            ...
                            >
                              <Typography className={classes.heading}>
                                ...
                                Task# {index + 1}- {task.taskIdentification}
                              </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                              <Grid item sm={12} xs={12}>
                                              ...
                                              <Grid container spacing={1}>
                                                ...
                                                >
                                                  <div
                                                    ...
                                                    style={{
                                                      backgroundColor: handleRiskChange(
                  ...
                  <Grid item md={12} sm={12} xs={12} className="paddTBRemove">
                    <Paper elevation={1} className="paperSection">
                            ...
                            props.visualConfirmations.map((visualConf) => (
                              <TableRow className={classes.cellHeight}>
                                <TableCell align="left">
                                  {visualConf.visualConfirmationType}
                                </TableCell>
                                <TableCell
                                  className="attachFileStylethum"
                                  align="left"
                                >
                      ...
                      >
                        ...
                        <Typography>{flha.permitToWork}</Typography>
                      </Grid>
                      <Grid
                        item
                        md={4}
                      ...
                      >
                        ...
                        <Typography>
                          {flha.permitToWorkNumber == undefined ||
                          flha.permitToWorkNumber == "undefined" ||
                          flha.permitToWorkNumber == ""
                            ? "-"
                            : flha.permitToWorkNumber}
                        </Typography>
                      </Grid>
                      ...
                      >
                        <FormLabel component="legend" className="viewLabel">
                          Permit job reference
                        </FormLabel>
                        <Typography>
                          {flha.referenceNumber == undefined ||
                          flha.referenceNumber == "undefined" ||
                    ...
                    <Paper elevation={1} className="paperSection">
                      <Grid container spacing={3}>
                        ...
                        <Grid item md={4} xs={12}>
                          ...
                          <Typography className="viewLabelValue">
                            {flha.emergencyPhoneNumber == undefined ||
                            flha.emergencyPhoneNumber == "undefined" ||
                      ...
                      <Grid container spacing={3}>
                        ...
                        <Grid item md={4} xs={12}>
                          ...
                          <Typography className="viewLabelValue">
                            {flha.evacuationPoint == undefined ||
                            flha.evacuationPoint == "undefined" ||
