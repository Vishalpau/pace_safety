...
const FlhaDetails = (props) => {
  ...
  const auditUserList = () => {
    api.get(`${SSO_URL}/api/v1/companies/` + JSON.parse(localStorage.getItem('company')).fkCompanyId + '/company-users/')
      .then(response => {
        setUser(response.data.data.results.users.map(user => ({ title: user.name })));
      });
  };
                          ...
                          <TableContainer>
                            <Table className={classes.table} aria-label="simple table">
                              ...
                              Identification information complete
                                  ...
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step1 == 'Yes'} onClick={() => setStep1('Yes')} />

                                  </TableCell>
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step1 == 'No'} onClick={() => setStep1('No')} />
                                  </TableCell>
                                  <TableCell align="left">
                                    <ActionTracker
                              ...
                              Job described accurately
                                  ...
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step2 == 'Yes'} onClick={() => setStep2('Yes')} />
                                  </TableCell>
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step2 == 'No'} onClick={() => setStep2('No')} />
                                  </TableCell>
                                  <TableCell align="left">
                                    <ActionTracker
                                      actionContext="flha:audit"
                              ...
                              Critical tasks identified
                                  ...
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step3 == 'Yes'} onClick={() => setStep3('Yes')} />
                                  </TableCell>
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step3 == 'No'} onClick={() => setStep3('No')} />
                                  </TableCell>
                                  <TableCell align="left">
                                    <ActionTracker
                                      actionContext="flha:audit"
                              ...
                              Applicable hazards identified
                                  ...
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step4 == 'Yes'} onClick={() => setStep4('Yes')} />
                                  </TableCell>
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step4 == 'No'} onClick={() => setStep4('No')} />
                                  </TableCell>
                                  <TableCell align="left">
                              ...
                              Controlled developed for hazards identified
                                  ...
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step5 == 'Yes'} onClick={() => setStep5('Yes')} />
                                  </TableCell>
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step5 == 'No'} onClick={() => setStep5('No')} />
                                  </TableCell>
                                  <TableCell align="left">
                              ...
                              All present energies identified at the job site
                                  ...
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step6 == 'Yes'} onClick={() => setStep6('Yes')} />
                                  </TableCell>
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step6 == 'No'} onClick={() => setStep6('No')} />
                                  </TableCell>
                                  <TableCell align="left">
                              ...
                              Energies isolated or controlled
                                  ...
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step7 == 'Yes'} onClick={() => setStep7('Yes')} />
                                  </TableCell>
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step7 == 'No'} onClick={() => setStep7('No')} />
                                  </TableCell>
                                  <TableCell align="left">
                              ...
                              Re-assessment of hazards completed after pause and restart
                                  ...
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step8 == 'Yes'} onClick={() => setStep8('Yes')} />
                                  </TableCell>
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step8 == 'No'} onClick={() => setStep8('No')} />
                                  </TableCell>
                                  <TableCell align="left">
                              ...
                              Agreement signed
                                  ...
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step9 == 'Yes'} onClick={() => setStep9('Yes')} />
                                  </TableCell>
                                  <TableCell align="left">
                                    <Checkbox inputProps={{ 'aria-label': 'uncontrolled-checkbox' }} disabled={!!isLock} checked={step9 == 'No'} onClick={() => setStep9('No')} />
                                  </TableCell>
                                  <TableCell align="left">
                    ...
                    <Grid item md={12} xs={12}>
                      <Grid item md={12} sm={12} xs={12} className="buttonActionArea">
                        <div className={classes.loadingWrapper}>
                          {isLock ? '' : (
                            <Button size="medium" variant="contained" color="primary" className="spacerRight buttonStyle" onClick={() => AuditCheckSubmit()} disabled={loading}>
                      Submit
                            </Button>
                          )}
                          {loading && (
