          ...
          <Grid container item xs={12} md={9} justify="flex-start" spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography className={Type.labelValue}>
                {moment(ahaListData.ahaAssessmentDate).format("Do MMMM YYYY")}
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                <Select
                  ...
                  label="Closed by"
                  value={
                    ahaListData.closedByName ? ahaListData.closedByName : ""
                  }
                >
            ...
            <Grid item xs={12} md={6}>
              <MuiPickersUtilsProvider utils={DateFnsUtils}>
                <KeyboardDateTimePicker
                  ...
                  helperText={error.closedDate ? error.closedDate : null}
