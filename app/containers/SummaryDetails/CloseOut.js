        ...
        <Grid item xs={12}>
          {incidents.closeDate ? (
            <Button
              variant="outlined"
              startIcon={<EditIcon />}
              onClick={(e) => handelCloseOut(e, "modify")}
            >
              Modify Close out
            </Button>
          ) : (
            <Button
              variant="outlined"
              startIcon={<EditIcon />}
              onClick={(e) => handelCloseOut(e, "add")}
            >
              Add Close out
            </Button>
          )}
        ...
        <Grid item xs={12}>
          ...
          >
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography className={classes.heading}>Close out</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Grid container item xs={12} spacing={3}>
                <Grid item xs={12} md={6}>
                  ...
                  <Typography className={Fonts.labelValue}>
                    ...
                    {incidents.reviewedByName === null ||
                    incidents.reviewedByName === "0"
                      ? "-"
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Typography className={Fonts.labelValue}>
                    {incidents.reviewDate
                      ? DateFormat(incidents.reviewDate, true)
                      : "-"}
                  </Typography>
                </Grid>
                <Grid item xs={12} md={6}>
                  ...
                  <Typography className={Fonts.labelValue}>
                    {incidents.closedByName === null ||
                    incidents.closedByName === "0"
                      ? "-"
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Typography className={Fonts.labelValue}>
                    {incidents.closeDate
                      ? DateFormat(incidents.closeDate, true)
                      : "-"}{" "}
                    {}
                  </Typography>
                </Grid>
