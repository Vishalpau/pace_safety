...
const PeoplesAffected = () => {
    ...
    if (personAffect === "Yes") {
      ...
      alert(personAffectedComments)
      {
        const data = {
          ...
          isPersonDetailsAvailable: personAffect,
          personAffectedComments: personAffectedComments,
  ...
  const handlePersonAffect = async (e) => {
