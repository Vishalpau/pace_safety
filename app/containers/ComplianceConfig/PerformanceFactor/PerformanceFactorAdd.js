...
const PerformanceFactorAdd = () => {
  ...
  const handleSave = async () => {
    ...
    const res = await api
      .post(`/api/v1/configaudits/factors/`, fectorForm)
      .then((res) => {
        localStorage.setItem("configTab", 1), history.goBack();
      })
      .catch((err) => console.log(error));
    setPerformError(
      "The combination of factor type is already exist in database."
    );
  };
  ...
  return (
    <>
      <CustomPapperBlock
        title="New performance factor"
        icon="customDropdownPageIcon compliancePerFactorPageIcon"
        whiteBg
      >
                    ...
                    <g id="factor-32" transform="translate(-402 -1921)">
                      ...
                      >
                        ...
                        <path
                          id="Path_6904"
                          data-name="Path 6904"
                          d="M127.89,141.436c-.789-.382-2.613-1.249-3.833-1.679h0a1.834,1.834,0,0,1-.5-.271l-1.408-1.074v-.591a5.017,5.017,0,0,0,1.5-2.09,1.718,1.718,0,0,0,1.215-1.636v-1.031a1.038,1.038,0,0,0-.619-.944v-1.737a3.345,3.345,0,0,0-1.341-2.7,4.724,4.724,0,0,0-2.908-.929s-.053,0-.15,0h0a4.823,4.823,0,0,0-2.758.934,3.339,3.339,0,0,0-1.336,2.7v1.737a1.033,1.033,0,0,0-.624.944V134.1a1.716,1.716,0,0,0,1.219,1.636,4.952,4.952,0,0,0,1.5,2.09v.591l-1.408,1.074h0a1.833,1.833,0,0,1-.5.271c-1.22.431-3.044,1.3-3.833,1.679h0a.866.866,0,0,0-.465.615l-.987,5.111h0a13.136,13.136,0,0,0,16.391,1.849,12.457,12.457,0,0,0,2.3-1.849l-.987-5.111a.854.854,0,0,0-.465-.614Z"
                          transform="translate(-62.407 -111.962)"
                          fill="#06425c"
                        />
                      </g>
                    </g>
                    ...
                    <Grid item md={4} sm={6} xs={12}>
                      ...
                      >
                        ...
                        <Select
                          ...
                          label="Factor type *"
                          value={
                            fectorForm.factorType ? fectorForm.factorType : ""
                          }
                          onChange={(e) => {
                            setFectorForm({
                              ...fectorForm,
                        ...
                        {error && error[`factorType`] && (
                          <FormHelperText>{error[`factorType`]}</FormHelperText>
                        )}
                      </FormControl>
                    </Grid>
                      ...
                      {fectorForm.factorType === "Status" ? (
                        ...
                        >
                          ...
                          <Select
                            ...
                            label="Factor name *"
                            value={
                              fectorForm.factorName ? fectorForm.factorName : ""
                            }
                            onChange={(e) => {
                              setPerformError(""),
                                setFectorForm({
                                ...
                                setError({ ...error, factorName: "" });
                            }}
                          >
                            <MenuItem value="Not in Compliance - Unsafe, Stop Work">
                              Not in Compliance - Unsafe, Stop Work
                            </MenuItem>
                            <MenuItem value="Not in Compliance  - Action required">
                              Not in Compliance  - Action required
                            </MenuItem>
                            <MenuItem value="Partial Compliance - Not satisfactory">
                              Partial Compliance - Not satisfactory
                            </MenuItem>
                            <MenuItem value="Compliant - Needs Improvement">
                              Compliant - Needs Improvement
                            </MenuItem>
                            <MenuItem value="Fully compliant">
                              Fully compliant
                            </MenuItem>
                            <MenuItem value="Full compliance & excellent">
                      ...
                      {fectorForm.factorType === "Status" ? (
                          ...
                          <Select
                            ...
                            onChange={(e) => {
                              setPerformError(""),
                                setFectorForm({
                                  ...fectorForm,
                                  factorConstant: e.target.value,
                                }),
                                setError({ ...error, factorConstant: "" });
                            }}
                          >
                        ...
                        >
                          ...
                          >
                            <MenuItem
                              value="1"
                              selected={fectorForm.factorConstant == 1}
                            >
                              1
                            </MenuItem>
                            <MenuItem
                              value="0.3"
                              selected={fectorForm.factorConstant == 0.3}
                            >
                              0.3
                            </MenuItem>
                            <MenuItem
                              value="0.6"
                              selected={fectorForm.factorConstant == 0.6}
                            >
                              0.6
                            </MenuItem>
                          </Select>
                    ...
                    <Grid item md={4} sm={6} xs={12}>
                      ...
                      <FormControlLabel
                        control={
                          <Switch
                            checked={
                              fectorForm.status === "Active" ? true : false
                            }
