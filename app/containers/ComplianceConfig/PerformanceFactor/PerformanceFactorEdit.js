...
const PerformanceFactorEdit = () => {
    ...
    return (
        <>
            <CustomPapperBlock title="Edit performance factor" icon='customDropdownPageIcon compliancePerFactorPageIcon' whiteBg>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item md={4} sm={6} xs={12}>
                                            ...
                                            >
                                                ...
                                                <Select
                                                    ...
                                                    label="Factor type"
                                                    value={fectorData.factorType ? fectorData.factorType : ""}
                                                    onChange={(e) => setFectorData({ ...fectorData, factorType: e.target.value })}
                                                >
                                        ...
                                        <Grid item md={4} sm={6} xs={12}>
                                            ...
                                            <FormControlLabel
                                                control={(
                                                    <Switch
                                                        checked={fectorData.status === "Active" ? true : false}
...
export default PerformanceFactorEdit;