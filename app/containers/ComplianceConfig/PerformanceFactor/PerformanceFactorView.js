...
const PerformanceFactorView = () => {
    const classes = useStyles();
    const history = useHistory();

    return (
        <>
        <CustomPapperBlock title="Performance factor" icon='customDropdownPageIcon compliancePerFactorPageIcon' whiteBg>
...
export default PerformanceFactorView;