...
{/* 
                ...
                <Grid item md={12} sm={12} xs={12} className="paddTBRemove">
                    <Paper elevation={1} className="paperSection">
                        <Grid container spacing={3}>
                            ...
                            {/* <Grid item md={12} sm={12} xs={12} className='paddBRemove'>
                              <FormLabel component="legend" className="checkRadioLabel">If Group and Subgroup not configured  Ask user to configure first </FormLabel>
                            </Grid>
                ...
                <Grid item md={12} sm={12} xs={12} className="paddBRemove">
                    ...
                    <FormLabel component="legend" className="checkRadioLabel errorMsgTxt">Compliance groups and sub-groups have not been configured!</FormLabel>
                </Grid>
                <Grid item md={12} sm={12} xs={12} className="paddTBRemove">
                    <Paper elevation={1} className="paperSection">
                        <Grid container spacing={3}>
                            <Grid item md={12} sm={12} xs={12} className='paddBRemove'>
                              <FormLabel component="legend" className="checkRadioLabel">Please configure groups and subgroups before this configuration </FormLabel>
                            </Grid>
                            <Grid item md={12} sm={12} xs={12}>
                              <IconButton
                                variant="contained"
            ...
            <DialogContent dividers={scroll === 'paper'}>
              ...
              >
                <Grid container spacing={3}>  
                  ...
                  <Grid item md={2} xs={3} align="right" className='customRowAdd'>
                    <IconButton
                      variant="contained"
                      color="primary"
                    >
                  ...
                  <Grid item md={12} sm={12} xs={12}>
                    <Button color="primary" variant="contained" className="buttonStyle">
                      Submit
                    </Button>
                  </Grid>
                </Grid>
